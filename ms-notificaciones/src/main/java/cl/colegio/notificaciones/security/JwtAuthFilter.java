...
/**
 * Filtro de autenticación JWT para el microservicio de notificaciones.
 *
 * <p>Intercepta cada request HTTP, extrae el Bearer token del header
 * Authorization, lo valida y establece el contexto de seguridad de Spring
 * con el RUT y rol del usuario para que los @PreAuthorize funcionen.
 *
 * <p>Patrón aplicado: Filter Chain (OncePerRequestFilter)
 */
@Slf4j
@Component
